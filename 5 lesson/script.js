...
Помню что мы прорешивали эту задачу, но тут осталось столько лишних комментов
что сейчас сложно проверить что-то.
 */
/*
let obj = {
  start:1,
...
/*
* тут будто твой первый варинат решения . мы ее решали на стриме с тобой и
* было покорче и покрасивее
* сейчас тут много лишних действий и резульатат не по условию
*
* */
